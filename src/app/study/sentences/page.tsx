...
import { sentenceItems } from "@/lib/mock-data";
    ...
    <AppShell>
      ...
      <div className="mt-8 flex flex-wrap gap-3">
        <label className="flex h-11 min-w-80 items-center gap-2 rounded-md border border-[var(--border)] bg-white px-3 text-sm">
          ...
          <input className="min-w-0 flex-1 outline-none" placeholder="搜索句子或解释" />
        </label>
