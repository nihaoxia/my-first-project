...
export const homePrototypeCopy = {
  heroTitle: "把 TXT 小说，变成可阅读、可学习、可逐章恢复的译本。",
  uploadWorkflowDescription:
    `当前支持 ${maxUploadSizeLabel} 以内 ${uploadFormatsLabel}，并保存到当前账号的浏览器书架。`,
  translationWorkflowDescription:
    "选择目标语言，通过已配置的 MCP 服务逐章生成真实译文；完成一章立即保存。",
  summary:
    "当前原型支持 TXT 拆章、MCP 逐章翻译、章节阅读与学习收藏。真实翻译需要配置 MCP 与 OpenAI 兼容模型服务；EPUB、真实计费、自动质检和生产导出仍待接入。",
} as const;
