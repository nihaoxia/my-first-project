...
TXT/EPUB 单文件上限为 2 MiB。EPUB 原文件、图片、封面、字体、CSS、音视频和原排版不会上传或保存；本地书架只保存提取后的章节文字。本地模式数据保存在浏览器当前账号作用域中，清理浏览器数据、使用无痕模式或设备损坏都可能导致本地数据丢失。

## 尚未实现

- MOBI、PDF 解析；
- DRM/加密、固定布局、漫画、多 rendition 以及保留 EPUB 图片或原排版；
- 真正的 EPUB 二进制打包与下载；
- AI 阅读问答；
- 语音朗读；
- 联网术语查证；
